...
// Without animation
// document.addEventListener('DOMContentLoaded', function() {
//     const yearTextElement = document.querySelector('.css-changes');
//     const slideYears = ['2023', '2023', '2024', '2023', '2024', '2024', '2024', '2024', '2024', '2024'];
...
//         if (yearTextElement && slideYears[index]) {
//             yearTextElement.textContent = `Lili Voss, ${slideYears[index]}`;
//         }
//     }
// });
// End  of Without animation

// With animation only years
document.addEventListener('DOMContentLoaded', function() {
    // 1. Get elements
    const yearContainer = document.querySelector('.css-1e3njhz');
    const yearGroup = yearContainer.children; // Gets SVG, empty span, and year text
    const slideYears = ['2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023'];
    
    // 2. Wrap all children in a div for group animation
    const wrapper = document.createElement('div');
    wrapper.className = 'year-group';
    while (yearContainer.firstChild) {
        wrapper.appendChild(yearContainer.firstChild);
    }
    ...
    // 4. Update function with animation
    function updateYear(index) {
        const yearElement = wrapper.querySelector('.css-1bwxqkp');
        if (!yearElement) return;
        
        const arrayIndex = index % slideYears.length;
        yearElement.textContent = `Lili Voss, ${slideYears[arrayIndex]}`;
...
// End of  With animation only years

// Your existing breakpoint detection and Swiper initialization code
var isBreakPoint = function (bp) {
    var bps = [359, 470, 653, 743, 853, 1023, 1041, 1407, 3840],
        w = $(window).width(),
        min, max;
...
if (isBreakPoint(3840)) {
    // With animation texts and years
    document.addEventListener('DOMContentLoaded', function() {
        // 1. Get elements
        const yearContainer = document.querySelector('.css-2222');
        const yearGroup = yearContainer.children; // Gets SVG, empty span, and year text
        const slideYears = ["Lili Voss, 2023", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam. Mariane Belkin, 2019", "George Lorens, 2023", "Lili Voss, 2023", "Laura Voss, 2024"];
        ...
        var swiper1 = new Swiper('.swiper-1', {
            ...
            on: {
                init: function() {
                    updateYear(this.realIndex);
                    updatePadding(this.realIndex); // NEW: Initialize padding
                },
                slideChangeTransitionStart: function() {
                    wrapper.classList.remove('fade-in');
                    wrapper.classList.add('fade-out');
                ...
                slideChangeTransitionEnd: function() {
                    updateYear(this.realIndex);
                    updatePadding(this.realIndex); // NEW: Update padding on slide change
                }
            }
        });

        // Add this new function without color chenges
        // function updatePadding(index) {
        //     const yearContainer = document.querySelector('.css-2222');
        //     if (!yearContainer) return;

        //     // Reset to default padding
        //     yearContainer.style.paddingTop = '3rem';

        //     // Apply 0 padding only for the second slide (index 1)
        //     if (index === 1) {
        //         yearContainer.style.paddingTop = '2rem';
        //     }
        // }
        ...
        function updatePadding(index) {
            const yearContainer = document.querySelector('.css-2222');
            const yearText = document.querySelector('.css-changes'); // Target the text element
            
            if (!yearContainer || !yearText) return;

            // Reset to defaults
            yearContainer.style.paddingTop = '3rem';
            yearText.style.color = '';

            // Custom styling for the second slide (index 1)
            if (index === 1) {
                yearContainer.style.paddingTop = '2rem';
                yearText.style.color = '#1a202c';
            }
        }

        // 4. Update function with animation
        function updateYear(index) {
            const yearElement = wrapper.querySelector('.css-changes');
            if (!yearElement) return;
            
            const arrayIndex = index % slideYears.length;
            yearElement.textContent = `${slideYears[arrayIndex]}`;
        ...
        // 5. Function to reset swiper without animation
        function resetSwiper() {
            // Temporarily disable transition
            swiper1.params.speed = 0;
            swiper1.update();
            
            // Reset to first slide
            swiper1.slideTo(1);
            
            // Restore original speed after a small delay
            setTimeout(() => {
                swiper1.params.speed = 300;
                swiper1.update();
            }, 10);
        }

        // 6. Handle gallery and close buttons
        $(".css-gallery").click(function() {

            let isActive = $(this).hasClass("chakra-portal-show");
            ...
            $(".chakra-portal").addClass("chakra-portal-show");
            // $(".body-project").addClass("overflow-hidden");
            resetSwiper();
        });
        
        $(".css-close").click(function() {

            let isActive = $(this).removeClass("chakra-portal-show");
            ...
            $(".chakra-portal").removeClass("chakra-portal-show");
            // $(".body-project").removeClass("overflow-hidden");
            resetSwiper();
        });
    });
}

if (isBreakPoint(1407)) {
    document.addEventListener('DOMContentLoaded', function() {
        // 1. Get elements
        const yearContainer = document.querySelector('.css-2222');
        const yearGroup = yearContainer.children; // Gets SVG, empty span, and year text
        const slideYears = ["Lili Voss, 2023", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam. Mariane Belkin, 2019", "George Lorens, 2023", "Lili Voss, 2023", "Lela Voss, 2024"];
        ...
        //     // Apply 0 padding only for the second slide (index 1)
        //     if (index === 1) {
        //         yearContainer.style.paddingTop = '1rem';
        //     }
        // }
...
if (isBreakPoint(1041)) {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add this new function without color changes
        // function updatePadding(index) {
        //     const yearContainer = document.querySelector('.css-2222');
        //     if (!yearContainer) return;

        //     // Reset to default padding
        //     yearContainer.style.paddingTop = '4rem';

        //     // Apply 0 padding only for the second slide (index 1)
        //     if (index === 1) {
        //         yearContainer.style.paddingTop = '0.8rem';
        //     }
        // }
...
if (isBreakPoint(653)) {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePadding(index) {
            const yearContainer = document.querySelector('.css-2222');
            const yearText = document.querySelector('.css-changes');
...
if (isBreakPoint(359)) {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        //     // Reset to default padding
        //     yearContainer.style.paddingTop = '5rem';

        //     // Apply 0 padding only for the second slide (index 1)
        //     if (index === 1) {
        //         yearContainer.style.paddingTop = '0.7rem';
        //     }
        // }
...
$(".read-more-button").click(function() {
    ...
    $(".css-xd74k3").toggleClass("css-xd74k3-rotate");
});
